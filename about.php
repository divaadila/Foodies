...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="about-text">
            <h2>About Us</h2>
            <p>Foodies hadir untuk merayakan keberagaman kuliner dunia. Kami menyajikan resep-resep autentik dari berbagai penjuru dunia, mengajak Anda untuk menjelajahi rasa dan tradisi unik dari setiap hidangan. Di sini, kami percaya bahwa setiap resep membawa cerita, dan kami ingin menjadi tempat di mana cerita-cerita itu bisa hidup dan dibagikan.</p>
        </div>
    </section>
